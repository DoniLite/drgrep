...
fn test_color_output_formatting() {
    ...
    let styled_text = format!("{}{}Important warning{}", Color::BOLD, Color::YELLOW, Color::RESET);
...
fn visual_color_test() {
    ...
    println!("{}{}UNDERLINED BLUE{}", Color::UNDERLINE, Color::BLUE, Color::RESET);
    println!("{}{}{}BOLD UNDERLINED GREEN{}", Color::BOLD, Color::UNDERLINE, Color::GREEN, Color::RESET);
}