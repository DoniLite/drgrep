...
fn test_printer_integration() {
    ...
    // Test print_styled
    print_styled("Integration test for styled printing", Color::BOLD, Color::GREEN);
...
fn test_macro_integration() {
    ...
    print_styled!("Styled macro integration test", Color::UNDERLINE, Color::MAGENTA);
